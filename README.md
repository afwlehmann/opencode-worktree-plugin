...
- **worktree_merge** — fast-forward merges the worktree branch back into the target branch, removes the worktree, cleans up permission tracking, and deletes the source branch (`git branch -d` only — never force-delete).
